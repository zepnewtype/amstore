      ...
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10 mb-10 md:mb-12">
          ...
          <div>
            ...
            <div className="flex mt-5 md:mt-6 space-x-5">
              <a
                ...
                className="hover:text-gold-DEFAULT transition-colors p-1 -ml-1"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-gold-DEFAULT transition-colors p-1"
          ...
          <div>
            ...
            <ul className="space-y-1 md:space-y-3">
              <li>
                <Link
                  to="/collections/tableware"
                  className="text-sm text-white/90 hover:text-gold-DEFAULT transition-colors inline-block py-2 md:py-0"
                >
                  Tableware
                </Link>
              </li>
            ...
            <ul className="space-y-4 text-sm text-white/90">
              <li className="flex items-start">
                ...
                <span>
                  ...
                  <a href="tel:+97152177347" className="hover:text-gold-DEFAULT transition-colors">
                    +971 52 177 3471
                  </a>
                </span>
              </li>
              <li className="flex items-start">
                ...
                <span>
                  ...
                  <a href="mailto:info@amprio.ae" className="hover:text-gold-DEFAULT transition-colors">
                    info@amprio.ae
                  </a>
                </span>
              </li>
              <li className="flex items-start">
                ...
                <span>
                  ...
                  1802 Ontario Tower, Business Bay
                  <br />
                  Dubai UAE
                </span>
              </li>
        ...
        <div className="pt-6 border-t border-white/20 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4 md:space-x-6 mt-4 md:mt-0">
            <Link to="/terms" className="text-xs text-white/70 hover:text-gold-DEFAULT transition-colors py-1">
              Terms & Conditions
            </Link>
            <Link to="/privacy" className="text-xs text-white/70 hover:text-gold-DEFAULT transition-colors py-1">
              Privacy Policy
            </Link>
            <Link to="/sitemap" className="text-xs text-white/70 hover:text-gold-DEFAULT transition-colors py-1">
              Sitemap
            </Link>
          </div>
        </div>
